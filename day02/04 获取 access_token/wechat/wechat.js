...
(async ()=>{
    let w= new Wechat()
   let result1=await w.fetchAccess()
   console.log(result1)

   let result2=await w.fetchAccess()
   console.log(result2)
   console.log(result1.access_token===result2.access_token,result1.expires_in===result2.expires_in)
